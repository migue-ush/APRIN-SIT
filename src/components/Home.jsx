...
import ImgFondo from '/img/img-home-aprin.avif';

const Home = () => {
    return (
    <div className="relative flex h-screen content-center items-center justify-center pt-16 pb-32 font-mont" >
        <div className="absolute top-0 h-full w-full bg-cover bg-center opacity-70" style={{ backgroundImage: `url(${ImgFondo})` }}/>
