...
const Home = () => {
    ...
    <div className="relative flex h-screen content-center items-center justify-center pt-16 pb-32 " >
        ...
        <div className=" container pt-[40%] md:pt-[30%] lg:pt-[23%] xl:pt-[15%] pl-5 flex-col bg-opacity-50 absolute">
            ...
            <Typography 
                ...
                className="opacity-60 sm:text-lg pl-5 font-bold lg:text-2xl md:text-xl tracking-widest pt-[40%] md:pt-[30%] lg:pt-[23%] xl:pt-[15%]">
