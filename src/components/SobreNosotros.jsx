...
const SobreNosotros = () => {
    return (
        <div className='bg-purple-900' id='Nosotros'>
            <div className='w-[90%] container mx-auto'>
                ...
                <section className='section-about w-full bg-purple-900 grid grid-cols-4 '>
                    ...
                    <div className='w-[95%] grid col-span-4 place-items-center p-5 md:col-span-2'>
                        <h1 className='text-3xl text-white w-[100%] font-bold my-5 text-center' >SOBRE NOSOTROS</h1>
                        <p className='text-white text-lg w-[100%] text-justify'>Somos una empresa joven de soluciones IT que integra consultoría en informática, desarrollo de sistemas de información, diseño de soluciones, servicio de soporte técnico y asesoramiento profesional</p>        
                    </div>
                </section>
            </div>
        </div>
