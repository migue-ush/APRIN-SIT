...
return (
    <nav className=" opacity-100 gap-3 grid  md:grid-cols-3  ">
        <ul className="pt-12 pl-5 gap-x-14 hidden xl:text-xl lg:text-lg md:text-sm md:grid md:grid-cols-4 ">
            ...
            <li className=''><a href="#" className="text-white md:col-span-1 ">Nosotros</a></li>
            <li className=''><a href="#" className="text-white md:col-span-1">Servicios</a></li>
            <li className=''><a href="#" className="text-white md:col-span-1">Contactos</a></li>
        </ul>
        ...
        <div class="space-y-2 grid pt-14 pl-5 sm:pl-10 absolute md:hidden">
            <div class="w-8 h-0.5 bg-gray-100"></div>
            <div class="w-8 h-0.5 bg-gray-100"></div>
            <div class="w-8 h-0.5 bg-gray-100"></div>
        </div>
    </nav>
